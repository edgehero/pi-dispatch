...
- **Acceptance**: Given a trigger without `run.resume`, no file is written under `PI_SESSIONS_DIR`, no
  ...
  touched still resumes. Given a trigger moved from one venue to another, its next job cold-starts with
