...
- **Targets**: a **local folder** on the operator's machine (edited in place — the primary self-hosted
  ...
  token; on Forgejo a repository-scoped access token; on Azure DevOps a PAT for a dedicated identity.
