...
- **Why**:
  ...
  - **The injection boundary holds by placement, not by filtering.** Raw container `.log` output is
    ...
    **What this does NOT answer**: the substitution makes a difference visible, it does not say which of
    ...
    measurement site scrubs BEFORE it measures. "They measure zero columns now" was false of nearly half of
    them and took two review rounds to stop saying: 65 of the members are what a terminal executes and 16
    are blanks, all of which measure one.
