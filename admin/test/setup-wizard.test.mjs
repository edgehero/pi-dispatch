...
test("wizard: the edge's service answer installs the PINNED receiver, then the --receiver unit", async () => {
  ...
  assert.ok(attached[0].args.includes(`${RECEIVER_PKG}@1.0.0`), "the pinned name@version token, spelled out");
  ...
  assert.match(c.message, new RegExp(`${RECEIVER_PKG.replace("/", "\\/")}@1\\.0\\.0`), "the confirm shows the exact pin");
