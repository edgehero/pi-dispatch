...
test("parseExitSession refuses a reason outside the CLOSED enum", () => {
	...
	for (const reason of ["resumed", "absent", "expired", "conversation-too-old", "resume-chain-too-long", "context-too-full", "too-large", "unparseable", "not-a-regular-file", "venue-changed", "pi-version-changed", "locked", "promote-failed", "disabled"]) {
