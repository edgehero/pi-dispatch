 ...
 *
 * `prepared.sandbox` is `{ jobId, kind, image, backend, jobUser? }`, stamped by `makePrepareWorkspace` (`jobUser` only
 * when the processor decided one, issue #341). Absent (a bare
