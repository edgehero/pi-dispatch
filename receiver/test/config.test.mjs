...
test("a valid secret + triggers file yields conservative defaults and grouped webhook triggers", () => {
	...
	assert.deepEqual(c.triggers.github.comment, { index: 1, phrase: "@pi", defaultFlow: "triage", command: undefined, packages: undefined, image: undefined, skillsDir: undefined, instructions: undefined, resume: undefined, secrets: undefined, secretsProfile: undefined, replicas: undefined, repository: undefined });
