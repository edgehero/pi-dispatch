...
setting that quietly does nothing. It is read only once `GITLAB_TOKEN` is set: with no token there is no
GitLab configured and the whole block, this variable included, is skipped.
